...
export class AddUser1763401127478 implements MigrationInterface {
  name = 'AddUser1763401127478';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('user', 'admin', 'super-admin')`,
    );
    await queryRunner.query(
